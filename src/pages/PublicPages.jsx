...
function HeroSearch({ initialFilters, genres, genresLoading, onSearch }) {
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-books" aria-hidden="true"><span className="hero-book hero-book-one"><small>Historias</small><strong>que nos<br />encuentran</strong></span><span className="hero-book hero-book-two"><small>Autores</small><strong>de aca<br />y de alla</strong></span><span className="hero-book hero-book-three"><small>Lecturas</small><strong>para cada<br />momento</strong></span><span className="hero-open-book"><span className="hero-open-book-page hero-open-book-page-left" /><span className="hero-open-book-page hero-open-book-page-right" /><span className="hero-catalog-card"><span /><span /><span /></span></span><span className="hero-leaf hero-leaf-one" /><span className="hero-leaf hero-leaf-two" /></div>
