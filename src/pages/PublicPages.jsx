...
export function PlansPage({ isRegistrationFlow = false }) {
  ...
  const plans = [
    ...
    { code: "base", name: "Base + IA", price: priceLabel("base"), detail: "/mes", limit: "Hasta 40 libros", benefits: ["Todas las funcionalidades web", "Funcionalidades de IA incluidas", "Acceso al bot de Telegram"], tone: "featured" },
  ];
