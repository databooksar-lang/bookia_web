  ...
  return (
    <div className="editorial-page about-page">
      <section className="about-hero-modern">
        ...
        <div className="about-hero-panel" aria-hidden="true"><span className="about-panel-kicker">CATÁLOGOS REALES</span><div><BookIcon size={30} /><strong>Buscá lo que querés leer</strong><small>Título, autor, editorial o género.</small></div><div><StoreIcon size={30} /><strong>Descubrí quién lo tiene</strong><small>Librerías y vendedores con sus datos públicos.</small></div><div><WhatsAppIcon size={30} /><strong>Contactá directamente</strong><small>Consultá disponibilidad sin intermediarios.</small></div></div>
      </section>
