...
export function PlansPage({ isRegistrationFlow = false }) {
  ...
  const plans = [
    { code: "trial", name: "Prueba gratis", price: "Sin costo", detail: "por 15 dias", limit: "Hasta 10 libros", benefits: ["Carga manual desde web y Telegram", "Carga por foto con IA en web, Android y Telegram", "Integraciones con tiendas"], tone: "base" },
