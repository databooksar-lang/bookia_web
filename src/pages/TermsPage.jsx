...
export function TermsPage() {
  return (
    <article className="editorial-page about-page legal-page">
      ...
      <p>Una persona lectora puede activar gratuitamente y de forma inmediata la capacidad de autor. Al hacerlo declara que es autora o que cuenta con autorizacion suficiente para publicar las obras que incorpore, y asume responsabilidad por la veracidad de los datos y por los derechos sobre ese contenido. Mientras la capacidad este activa y su perfil lector sea publico, Bookia mostrara la insignia Autor/a en Bookia. La capacidad puede desactivarse; Bookia tambien puede ocultar contenido o suspenderla ante infracciones, reclamos, abuso o riesgos para terceros o para la plataforma.</p>
