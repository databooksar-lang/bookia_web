...
export function TermsPage() {
  return (
    <article className="editorial-page about-page legal-page">
      ...
      <p>Las nuevas librerias acceden a una prueba gratis de 30 dias desde el registro, con hasta 10 libros y sin solicitar medio de pago ni realizar cobros automaticos. Finalizada la prueba, Bookia restringe las modificaciones hasta que la libreria elija y autorice una suscripcion mensual en Mercado Pago. Un cambio de plan o capacidad solicitado por la libreria se aplica en la renovacion siguiente, sin prorrateo.</p>
