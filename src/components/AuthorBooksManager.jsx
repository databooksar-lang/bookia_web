  ...
  return <section className="author-books" aria-labelledby="author-books-title">
    ...
    {canCreate ? <form className="dashboard-card author-book-form" onSubmit={onSubmit}>
      ...
      <div className="author-book-form-grid">
        ...
        <label className="author-book-field-wide"><span>Enlace externo <small>(opcional)</small></span><input type="text" inputMode="url" value={draft.external_url} onChange={(event) => onDraftChange("external_url", event.target.value)} maxLength={500} placeholder="tu-tienda.com/libro" disabled={saving} /></label>
